...
- **Natural Language Processing** - Machine-generated code detection
- **Graph Neural Networks** - Cybersecurity threat detection
- **AI in Healthcare** - Non-invasive glucose monitoring systems
- **Cybersecurity** - Intrusion detection using ML

## Current Focus
```javascript
const subhiksha = {
    learning: ["Machine Learning", "NLP", "Graph Neural Networks"],
